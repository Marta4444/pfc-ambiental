            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 border-b border-gray-200">
                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        <form action="{{ route('admin.species.importSpanish') }}" method="POST" class="inline" onsubmit="return confirm('Este proceso puede tardar varios minutos. ¿Continuar?')">
                            @csrf
                        ...
                        <form action="{{ route('admin.species.enrich') }}" method="POST" class="inline" onsubmit="return confirm('El enriquecimiento puede tardar varios minutos. ¿Continuar?')">
                            @csrf
