<x-app-layout>
                ...
                <div class="p-6">
                    <form action="{{ route('fields.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="flex justify-end space-x-3">
                            <a href="{{ route('fields.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-300 border border-transparent rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-400">
                                Cancelar
                            </a>
    ...
    <script>
        ...
        // Verificar al cargar si ya hay un tipo seleccionado
        if (optionsRequiringTypes.includes(typeSelect.value)) {
            optionsContainer.classList.remove('hidden');
        }
    </script>
</x-app-layout>